...
public class AuthorServiceImpl implements AuthorService {
    ...
    public Author getAuthorById(long id) {
        Author author = authorRepository.findById(id).orElseThrow(()->new ResourceNotFoundException("Author","id", String.valueOf(id)));
        return author;
    }

    @Override
    public Author updateAuthor(Author author, long id) {
        Author target = authorRepository.findById(id).orElseThrow(()->new ResourceNotFoundException("Author","id", String.valueOf(id)));
