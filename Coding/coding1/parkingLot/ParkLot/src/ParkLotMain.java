import com.parkLot.spot.CompactSpot;
import com.parkLot.spot.LargeSpot;
import com.parkLot.spot.MotorcycleSpot;
import com.parkLot.spot.Spot;
import com.parkLot.vehicle.Bus;
import com.parkLot.vehicle.Car;
import com.parkLot.vehicle.Motorcycle;
...
public class ParkLotMain {
    ...
    public ParkLotMain(int level, int row, int column) {
        LEVEL = level;
        ROW = row;
        COLUMN = column;
