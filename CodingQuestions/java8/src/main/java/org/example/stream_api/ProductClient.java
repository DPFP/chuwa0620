...
public class ProductClient {
    ...
    public void toList() {
        ...
        // Stream<Product> stream_product =  productList.stream();
    ...
    public void toSet() {
        ...
        Set<String> uniqueCategories = productList.stream()
                .map(Product::getCategory) //.map(p->p.getCategory())
    ...
    public void partitioningBy() {
        // partition by whether price is higher than 100
    ...
    public void mapping() {
        ...
        Set<String> upperNames = productList.stream()
