...
public class ShoppingCartUtil {
    ...
    public static void main(String[] args){
        Item item1 = new Item("Apple",2.0);
        Item item2 = new Item("Banana",4.0);
        ...
        Optional<String> result = ShoppingCartUtil.getFirstItemName(customer);
    }
    /**
    ...
    public static String getFirstItemNameOrThrowException(Customer customer) throws EmptyCartException {
        return Optional.ofNullable(customer)
                ...
                .map(items -> items.get(0))
                .map(Item::getName)
                .orElseThrow(() -> new EmptyCartException("Cart Empty or do no exist"));
    }
